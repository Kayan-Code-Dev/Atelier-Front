...
class RentalOrderPresenter
{
    ...
    {
        $invoice->loadMissing(['customer', 'branch', 'createdBy', 'employee', 'items.dress', 'payments']);
        ...
        $payload = [
            ...
            'employee_name' => $invoice->employee?->full_name ?? $invoice->createdBy?->name ?? '',
            'branch_name' => $branch?->name ?? '',
            'branch' => BranchLogoResolver::present($branch),
