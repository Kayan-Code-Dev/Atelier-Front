...
class InvoiceDeliveryService
{
    ...
    public function deliver(Invoice $invoice, array $data, ?int $actorId = null): Invoice
    {
        ...
        app(OperationalNotificationService::class)->invoiceDelivered($updated);
    ...
    public function returnRentInvoice(Invoice $invoice, array $data, ?int $actorId = null): Invoice
    {
        ...
        app(OperationalNotificationService::class)->invoiceReturned($updated);

        try {
            $tenant = app(TenantContext::class)->tenant();
            if ($tenant !== null) {
                app(TenantWhatsAppInvoiceNotifier::class)->notifyReturnCongrats($tenant, $updated);
            }
        } catch (Throwable $e) {
            Log::warning('whatsapp.return_congrats_failed', [
