...
class StorePlanRequestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email_verification_token' => ['required', 'string', 'min:32', 'max:128'],
            ...
            'payment_proof' => array_merge(
                ...
                ['file', 'mimes:jpg,jpeg,jfif,png,webp,gif', 'max:5120'],
            ),
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'email_verification_token.required' => 'يجب التحقق من البريد الإلكتروني أولاً.',
            ...
            'payment_proof.image' => 'يجب أن يكون إيصال الدفع صورة (JPG أو PNG أو JFIF).',
            'payment_proof.mimes' => 'يجب أن يكون إيصال الدفع صورة (JPG أو PNG أو JFIF).',
