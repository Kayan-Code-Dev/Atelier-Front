...
class StoreHrEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return array_merge([
            ...
            'commission_type' => ['nullable', 'string', Rule::in(\App\Enums\HrCommissionType::values())],
            'commission_fixed_amount' => ['nullable', 'numeric', 'min:0'],
            'commission_rate' => ['nullable', 'numeric', 'min:0', 'max:100'],
            'commission_activity' => ['nullable', 'string', Rule::in(\App\Enums\HrCommissionActivity::values())],
