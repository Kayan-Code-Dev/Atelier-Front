...
class UpdateHrEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return array_merge([
            ...
            'branch_ids.*' => ['integer', Rule::exists('tenant.branches', 'id')],
            ...
            'commission_type' => ['sometimes', 'nullable', 'string', Rule::in(\App\Enums\HrCommissionType::values())],
            'commission_fixed_amount' => ['sometimes', 'nullable', 'numeric', 'min:0'],
            'commission_rate' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:100'],
            'commission_activity' => ['sometimes', 'nullable', 'string', Rule::in(\App\Enums\HrCommissionActivity::values())],
